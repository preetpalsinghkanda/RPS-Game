...
const Navbar = ({ score }) => {
  return (
    <div className="md:border-4 border-2 items-center mt-6 md:mt-6 border-[#ffffff4e] flex md:mx-auto justify-between md:min-w-2xl sm:min-w-md min-w-full rounded-xl mx-auto md:px-6 px-3 md:py-4 py-2">
